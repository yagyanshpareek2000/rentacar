<div class="col-12 col-xl-12">
  <div class="card">
    <div class="card-header">
      <h5 class="card-title" style="    width: 50%; float: left;">Periodlar</h5>
      <button class="btn btn-sm btn-success slide-right" style="    width: 10%; float: right;">  Yeni Period Ekle  </button>
    </div>
    <div class="card-body">
      <table id="datatables-basic" class="table table-striped" style="width:100%">
        ...
        <tbody>
          ...
          <tr>
            <td><?=$val->name?></td>
              <td><a class="btn btn-sm btn-danger" href="<?=base_url()?>Backend/Car/deleteperiod/<?=$val->id?>" onclick="return confirm('Silmek istediğinizden eminmisiniz?');"><i class="ion ion-ios-trash"></i></a> </td>
           </tr>
         <?php } ?>
          </tfoot>
      </table>
  ...
  <div class="box-inner">
    <div class="col-12 col-xl-12" style="height:100%;padding:0">
      <div class="card" style="height:100%;border-radius:0">
        <div class="card-header">
          <h5 class="card-title">Period Ekleme Formu</h5>
        </div>
        <div class="card-body">
          <form method="post" action="<?=base_url()?>Backend/Car/periodadd" enctype='multipart/form-data'>
              <div class="form-group">
                <label class="form-label">Period Adı</label>
