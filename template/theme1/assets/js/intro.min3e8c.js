    ...
    function _showElement(targetElement) {
        ...
        if (oldHelperLayer != null) {
            ...
            if (this._options.showStepNumbers == true) {
                ...
                //TODO Salih : buraya options cak pull request cek :D
        ...
        if (this._currentStep == 0 && this._introItems.length > 1) {
            ...
            if (this._currentStep == (this._introItems.length - 1)) {
                skipTooltipButton.className = 'introjs-button introjs-skipbutton introjs-done';
            }
        } else {
            prevTooltipButton.className = 'introjs-button introjs-prevbutton';
            nextTooltipButton.className = 'introjs-button introjs-nextbutton';
        ...
        if(this._currentStep == 0){
            this._options.nextLabel = 'Evet';
            nextTooltipButton.innerHTML = this._options.nextLabel;
        }else{
            this._options.nextLabel = 'İleri';
            nextTooltipButton.innerHTML = this._options.nextLabel;
        }

        if(this._currentStep == 5){
            $('.introjs-skipbutton').show();
            $('.introjs-prevbutton').addClass('last-back');
            $('.introjs-done').addClass('introtopback');
            $('.introtopback').click(function(){
        ...
        if (this._options.scrollToElement === true) {
            var rect = targetElement.element.getBoundingClientRect(),
                ...
                top = rect.bottom - ((rect.bottom - rect.top) + 90),
            ...
            if (top < 0 || targetElement.element.clientHeight > winHeight) {
                ...
                window.scrollBy(0, top + -50); // 70px + 30px padding from edge to look nice
            }
        }
