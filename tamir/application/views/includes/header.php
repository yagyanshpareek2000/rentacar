				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="<?=base_url()?>setting/edit_user?id=<?php echo $user_id; ?>"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Profil</a></li>
							<li><a href="<?=base_url()?>setting/users"><svg class="glyph stroked gear"><use xlink:href="#stroked-gear"></use></svg> Ayarlar</a></li>
							<li><a href="<?=base_url()?>auth/logout"><svg class="glyph stroked cancel"><use xlink:href="#stroked-cancel"></use></svg> Çıkış Yap</a></li>
						</ul>
					</li>
				</ul>
			</div>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li <?php if ($tk_c == "dashboard") {
				...
				<a href="<?=base_url()?>dashboard"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg> Anasayfa</a>
			</li>
			...
			<li <?php if ($tk_c == "services") {
				...
				<a data-toggle="collapse" href="#services">
					<svg class="glyph stroked table"><use xlink:href="#stroked-table"/></svg>  Servis
				</a>
			...
			<li <?php if ($tk_c == "cars") {
				...
				<a data-toggle="collapse" href="#cars">
					<svg class="glyph stroked table"><use xlink:href="#stroked-table"/></svg>  Araçlar
				</a>
			...
			<li <?php if ($tk_c == "customers") {
				...
				<a data-toggle="collapse" href="#customers">
					<svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"/></svg>  Müşteriler
				</a>
			...
			<li <?php if ($tk_c == "materials") {
				...
				<a data-toggle="collapse" href="#materials">
					<svg class="glyph stroked table"><use xlink:href="#stroked-table"/></svg>  Malzemeler
				</a>
			...
			<li <?php if ($tk_c == "packages") {
				...
				<a data-toggle="collapse" href="#service_packages">
					<svg class="glyph stroked table"><use xlink:href="#stroked-table"/></svg>  Servis Paketleri
				</a>
			...
			<li <?php if ($tk_c == "purchase_order") {
				...
				<a data-toggle="collapse" href="#po">
					<svg class="glyph stroked table"><use xlink:href="#stroked-table"/></svg> Satın alma emri
				</a>
			...
			<li <?php if ($tk_c == "setting") {
				...
				<a data-toggle="collapse" href="#setting">
					<svg class="glyph stroked gear"><use xlink:href="#stroked-gear"/></svg>  Ayar
				</a>
		...
		<ul class="nav menu">
			...
			<li <?php if ($tk_c == "services") {
				...
				<a data-toggle="collapse" href="#services">
					<svg class="glyph stroked table"><use xlink:href="#stroked-table"/></svg>  Servisler
				</a>
				<ul class="children <?php if ($tk_c != "services") {
                    ?> collapse <?php 
                } ?>" id="services">
			...
			<li <?php if ($tk_c == "setting") {
				...
				<a data-toggle="collapse" href="#setting">
					<svg class="glyph stroked gear"><use xlink:href="#stroked-gear"/></svg>  Ayarlar
				</a>
				<ul class="children <?php if ($tk_c != "setting") {
                    ?> collapse <?php 
                } ?>" id="setting">
